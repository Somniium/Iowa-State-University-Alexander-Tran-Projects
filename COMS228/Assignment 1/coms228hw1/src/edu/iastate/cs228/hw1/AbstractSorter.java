...
public abstract class AbstractSorter {
	...
	protected AbstractSorter(Point[] pts) throws IllegalArgumentException {
		if (pts == null || pts.length == 0) {
			throw new IllegalArgumentException("Input array 'pts' cannot be null or empty");
		}
	...
	public void setComparator(int order) throws IllegalArgumentException {
		...
		// Set whether to compare by x or y
		if (order == 0) {
			Point.setXorY(true); // Compare by x
		} else {
			Point.setXorY(false); // Compare by y
		}
	...
	public void getPoints(Point[] pts) {
		if (pts == null || pts.length < points.length) {
			throw new IllegalArgumentException("Target array is null or too small");
		}
