...
public class PeopleController {
    ...
    /*
        Returns all people sorted alphabetically by name.
     */
    ...
    // THIS IS A GET METHOD
    // Similar to the previous method, but searches using address instead
    @GetMapping({"/people/contains/address"})
    public List<Person> getPersonByAddr(@RequestParam("address") String address) {
        List<Person> res = new ArrayList();
    ...
    //THIS IS A GET METHOD
    // Similar to the previous method, but searches using phone number instead
    @GetMapping({"/people/contains/telephone"})
    public List<Person> getPersonByTele(@RequestParam("telephone") String telephone) {
        List<Person> res = new ArrayList();
        for(Person p : this.peopleList.values()) {
