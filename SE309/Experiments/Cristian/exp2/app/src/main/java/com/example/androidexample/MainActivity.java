...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChuckNorrisButton = findViewById(R.id.main_chuck_btn);
        ...
        else if(extras.containsKey("ChuckJoke") ){
            String Joke = extras.getString("ChuckJoke");
        ...
        ChuckNorrisButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /* when chuckNorris button is pressed, use intent to switch to ChuckNorrisJokes Activity */
                Intent intent = new Intent(MainActivity.this, ChuckNorrisJokes.class);
                startActivity(intent);
            }
        });
    }
