...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageText = findViewById(R.id.AppName_txt);      // link to message textview in the Main activity XML
        messageText.setText("CyVal");

        messageText = findViewById(R.id.TitleMessage_txt);      // link to message textview in the Main activity XML
        messageText.setText("Opinions Matter");
    }
}