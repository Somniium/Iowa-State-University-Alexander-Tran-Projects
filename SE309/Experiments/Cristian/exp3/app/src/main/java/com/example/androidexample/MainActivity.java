...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView AppNameText;   // define AppName textView variable
    private Button loginButton;     // define login button variable
    private Button signupButton;    // define signup button variable
    private Button aboutUsButton;
    private Button guestViewButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppNameText = findViewById(R.id.AppName_txt);       // link to AppName textView in the Main activity XML
        loginButton = findViewById(R.id.main_login_btn);    // link to login button in the Main activity XML
        signupButton = findViewById(R.id.main_signup_btn);  // link to signup button in the Main activity XML
        aboutUsButton = findViewById(R.id.about_btn);
        guestViewButton = findViewById(R.id.guest_btn);

        //sets the AppName to cyVal
        AppNameText.setText("CyVal");
