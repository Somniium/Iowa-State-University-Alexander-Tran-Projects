...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView userTypeText;  // define username textview variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userTypeText = findViewById(R.id.main_usertype_txt);// link to username textview in the Main activity XML
        ...
        if(extras == null) {
            ...
            userTypeText.setVisibility(View.INVISIBLE);             // set username text invisible initially
        } else {
            if (extras.getString("USERTYPE").equals("guest")) {
                messageText.setText("Welcome, Guest!");
            } else {
                messageText.setText("Welcome, " + extras.getString("USERNAME") + "!");
            }
            userTypeText.setText(extras.getString("USERTYPE") + " User"); // this will come from LoginActivity
