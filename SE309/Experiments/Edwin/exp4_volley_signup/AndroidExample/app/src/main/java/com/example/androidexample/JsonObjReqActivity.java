...
public class JsonObjReqActivity extends AppCompatActivity {
    ...
    private static final String URL_JSON_OBJECT = "http://10.0.2.2:8080/users/1";
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        //Parse user object into data
                        String password;
                        try {
                            password = user1.get("password").toString();
                        } catch (JSONException e) {
                            throw new RuntimeException(e);
                        }

                        // Display response in TextView
                        msgResponse.setText(password);
                    }
                },
