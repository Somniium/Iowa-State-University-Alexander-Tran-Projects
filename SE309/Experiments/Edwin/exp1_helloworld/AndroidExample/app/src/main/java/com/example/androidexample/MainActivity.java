...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageText = findViewById(R.id.title_txt);      // link to message textview in the Main activity XML
        messageText.setText("CyVal");

        messageText = findViewById(R.id.music_txt);      // link to message textview in the Main activity XML
        messageText.setText("Music");

        messageText = findViewById(R.id.book_txt);      // link to message textview in the Main activity XML
        messageText.setText("Books");

        messageText = findViewById(R.id.academic_txt);      // link to message textview in the Main activity XML
        messageText.setText("Academic Papers");

        messageText = findViewById(R.id.other_txt);      // link to message textview in the Main activity XML
        messageText.setText("Other");
    }
}